...
import 'package:biodiversity/presentation/report/widgets/report_step_five.dart';
import 'package:biodiversity/presentation/report/widgets/report_step_four.dart';
import 'package:biodiversity/presentation/report/widgets/report_step_one.dart';
import 'package:biodiversity/presentation/report/widgets/report_step_three.dart';
import 'package:biodiversity/presentation/report/widgets/report_step_two.dart';
import 'package:biodiversity/presentation/result/result_provider.dart';
        ...
        BlocListener<ReportCubit, ReportState>(
          ...
          listener: (context, state) {
            if (state.submitStatus.isSubmissionSuccess) {
              ...
              Navigator.push(context, ResultProvider.route());
            }
